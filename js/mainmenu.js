...
$(function () {
    $("#mainmenu").html(`<nav class="navbar navbar-expand-lg navbar-dark bg-dark" aria-label="Tenth navbar example">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown"> <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown"     aria-expanded="false">2023</a> 
              <ul class="dropdown-menu">     
                <li><a class="dropdown-item" href="2023apr.html">April</a></li>     
                <li><a class="dropdown-item" href="#march">March</a></li>     
                <li><a class="dropdown-item" href="#february">February</a></li> 
              </ul>
            </li>  
            <li class="nav-item"> <a class="nav-link" href="#2022">2022</a>  </li>
            <li class="nav-item"> <a class="nav-link" href="2021.html">2021</a>  </li>  
